...
export type CreateFlashcardMutationVariables = Exact<{
  setId: Scalars['ID']['input'];
  faces: Array<CreateFlashcardFaceInput> | CreateFlashcardFaceInput;
}>;
