...
const LANGUAGE_CONFIGS: Record<string, LanguageFaceConfig> = {
    Chinese: {
        required: [FaceType.WORD, FaceType.CHARACTER, FaceType.TRANSLATION],
        optional: [
            FaceType.PINYIN,
            FaceType.EXAMPLE_SENTENCE,
            FaceType.EXAMPLE_SENTENCE_TRANSLATION,
...
async function seedLanguageFaceConfigs() {
    return Promise.all(
